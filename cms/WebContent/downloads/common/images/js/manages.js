...
manages.cls = {
  tCBsize: function(_strtype, _strvalue)
  {
    ...
    $I("size").value = tbvalue;
    $I("kbsize").value = tkbvalue;
    $I("mbsize").value = tmbvalue;
  }
};
...
manages.urls = {
  ...
  tAdds: function(_strers)
  {
    ...
    if (manage.tckBackString(tstrers))
    {
      $I('urlsListFactory').innerHTML = tstrers;
      var tnewurlsObj = $I('urlsListFactory').getElementsByTagName('table')[0];
      if (tnewurlsObj) $I('urlsList').appendChild(tnewurlsObj);
    };
  },
  ...
  tEdits: function(_strers)
  {
    ...
    if (manage.tckBackString(tstrers))
    {
      ...
      $I('urlsnum').value = tAry.length;
      $I('urlsList').innerHTML = tstrers;
    };
  },
