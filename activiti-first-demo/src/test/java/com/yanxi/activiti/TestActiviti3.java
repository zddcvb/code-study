...
public class TestActiviti3 {
	private ProcessEngine processEngine;
	@Before
	public void test_engine(){
		InputStream inputStream=TestActiviti3.class.getClassLoader().getResourceAsStream("activiti.cfg.xml");
	...
	public void test_deploy(){
		...
		Deployment deploy = repositoryService.createDeployment().name("class1").category("yanxi.class1").addClasspathResource("class1.bpmn").deploy();
	...
	public void test_next_map(){
		...
		map.put("condition",2);
		RuntimeService runtimeService = processEngine.getRuntimeService();
		runtimeService.signal("5505", map);
	}
}
