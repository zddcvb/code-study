...
public class ActivitiTest {
	...
	public void test_processEngine() {
		...
		InputStream is = ActivitiTest.class.getClassLoader().getResourceAsStream("activiti.cfg.xml");
	...
	public void test_inputStreamDeploy() {
		RepositoryService repositoryService = processEngine.getRepositoryService();
		InputStream inputStream = ActivitiTest.class.getClassLoader().getResourceAsStream("anim.bpmn");
	...
	public void test_zipDeploy() {
		RepositoryService repositoryService = processEngine.getRepositoryService();
		InputStream inputStream = ActivitiTest.class.getClassLoader().getResourceAsStream("anim.bpmn.zip");
